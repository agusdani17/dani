...
for x in range(999):
	...
	TEMAN = f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,100))}.0.{str(rr(111,9999))}.{str(rr(100,300))} Mobile Safari/537.36"
	F = f"{TEMAN}"
	if F in redmi:pass
	else:redmi.append(F)
